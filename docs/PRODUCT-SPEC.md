...
**Não é**: um assistente de código, um editor, um cliente de chat, nem um wrapper do Claude Code. Ele produz o _prompt_; a execução continua sendo do Claude Code no terminal.
